...
description: Fetches bug tickets from Jira using Atlassian MCP and formats them for AI-assisted bug fixing. Creates structured bug-context.md with description, steps to reproduce, expected vs actual behavior. Use when user mentions Jira ticket key (EMS-1234, PROJ-567, TICKET-123), wants to fix a bug, starting bug-fixing workflow, need bug context from Jira, or fetching issue details for analysis. Requires Atlassian MCP connection.
license: MIT
...
â”œâ”€â”€ research/           # Will contain research documents
â””â”€â”€ bug-context.md      # Main bug context file
```
...
Create `.context/active/bugs/{TICKET-ID}/bug-context.md` using the template below.
...
```
âš ï¸ ATLASSIAN MCP CONNECTION ERROR
...
**Output:**
- Creates: `.context/active/bugs/EMS-1234/bug-context.md`
- Creates: `.context/active/bugs/EMS-1234/research/` directory
