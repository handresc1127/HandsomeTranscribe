...
- `.context/active/bugs/$1/`
- `.context/active/bugs/$1/research/`
...
Create the file `.context/active/bugs/$1/bug-context.md` with the following format:
...
```
âœ… Bug context created successfully!
...
**Output file:** .context/active/bugs/$1/bug-context.md
